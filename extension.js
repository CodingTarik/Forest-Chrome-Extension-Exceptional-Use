...
async function hideForest() {
	...
	{await sleep(100); counter++; if(counter > 100) break;}
...
setTimeout(function() {var shadow = document.getElementById("forest-ext-shadow-host").shadowRoot.querySelectorAll("div.sc-ftvSup.bYNZtS")[0];
	addBtn(shadow, 5);
	addBtn(shadow, 10);
	addBtn(shadow, 25);
	addBtn(shadow, 60);
